...
$repoArgs = @("repo", "create", $RepoName, "--public", "--description", "OpsPulse AI - Real-Time Operations Control Tower for Throughput, Backlog, SLA Risk and Staffing Decisions", "--source", ".", "--remote", "origin", "--push")
& $GhPath @repoArgs
